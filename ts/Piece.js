...
export class Piece {
    constructor(board, piece, color, position) {
    ...
    getLegalMoveIndexes() {
        ...
        switch (this.piece.toLowerCase()) {
            ...
            case PieceTypes.Pawn:
                ...
                if (this._rank === (this.color === Color.White ? 6 : 1) && // correct rank(row)
    ...
    isValidMoveIndex(index, file = this._file) {
        return !((index >= 64 || index < 0) || // this index is in bounds
